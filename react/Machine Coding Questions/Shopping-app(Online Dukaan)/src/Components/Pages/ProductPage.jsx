    ...
    product && (
      <div className="text-xl max-w-full h-[calc(100vh-4rem)] border border-red-800 flex items-center mt-16 justify-center select-none">
        ...
        >
          ...
          <div id={product.id} className="flex gap-x-2 items-center">
            <button
              className="bg-gray-300 px-20 py-2 text-[1.3rem] rounded"
              onClick={(e) => OnCartClickFunction(e)}
            >
              Add to Cart
            </button>
            ...
            <div id="bankOffers" className="flex flex-col gap-y-2 w-fit mt-2">
              ...
              <ul className="flex flex-col gap-1 text-lg pr-5">
                ...
                <li className="flex gap-x-1 items-center">
                  ...
                  <span>
                    <span className="font-semibold">Bank Offer</span> Flat
                    ₹1,250 off on HDFC Bank Credit Card EMI Txns on 6 and 9
                    months tenure, Min. Txn Value: ₹15,000{" "}
                    <span className="text-[#2874F0]">T&C</span>
                  </span>
                </li>
                <li className="flex gap-x-1 items-center">
                  ...
                  <span>
                    ...
                    extra 62% off (price inclusive of cashback/coupon){" "}
                    <span className="text-[#2874F0]">T&C</span>
                  </span>
                </li>
              </ul>
