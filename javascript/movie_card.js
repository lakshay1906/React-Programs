...
let movieData = [
  {
    ...
    movieTitle: "Uri",
    moviePrice: "$5",
    movieDesc: "Action movie",
  },
  {
    movieImg:
      "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQq8uLI_zyCYxBRO1u9FVJ0eoYl3R82HobrUQ&usqp=CAU",
    movieTitle: "Titanic",
    moviePrice: "$5",
    movieDesc: "Romantic movie",
  },
  {
    movieImg:
      "https://www.boxofficemovies.in/now/wp-content/uploads/Horizontal-poster-of-Tiger-Zinda-Hai.jpg",
    movieTitle: "Tiger Zinda Hai",
    moviePrice: "$5",
    movieDesc: "Action movie",
  },
];
